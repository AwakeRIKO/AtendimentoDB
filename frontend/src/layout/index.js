...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    '& .MuiButton-outlinedPrimary': {
      color: theme.mode === 'light' ? '#2862d9' : '#FFF',
      border: theme.mode === 'light' ? '1px solid #2862d9' : '1px solid rgba(255, 255, 255, 0.5)',
    },
        ...
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {greaterThenSm && user?.profile === "admin" && user?.company?.dueDate ? (
              <>
                Olá <b>{user.name}</b>, seja bem-vindo(a) ao <b>Atendimento DB</b>!
              </>
            ) : (
              <>
                Olá <b>{user.name}</b>, seja bem-vindo(a) ao <b>Atendimento DB</b>!
